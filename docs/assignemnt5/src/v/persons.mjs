 ...
 ***************************************************************/
 ...
 document.getElementById("RetrieveAndListAll")
     .addEventListener("click", function () {
         ...
         for (const key of Object.keys( Person.instances)) {
             ...
             // create list of movies directed by this director
             const listDirectorEl = createListFromMap(person.directedMovies, "title");
             row.insertCell().appendChild(listDirectorEl);
             // create list of movies played by this actor
             const listActorEl = createListFromMap(person.playedMovies, "title");
             row.insertCell().appendChild(listActorEl);
         }
 ...
 function refreshManageDataUI() {
     // show the person person UI and hide the other UIs
