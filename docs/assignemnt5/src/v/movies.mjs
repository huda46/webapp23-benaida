 ...
 ***************************************************************/
  ...
  **********************************************/
 /**
  * Initialize the update movies UI/form. Notice that the Association List Widget for
  * associated actors is left empty initially. It is only set up on movie selection
  */
 const updateFormEl = document.querySelector("section#Movie-U > form");
 const updateSelectMovieEl = updateFormEl.selectMovie;
